...
const MessageDetail = ({ isMobile, onBack }) => {
  ...
  const recipientProfileImg =
    recipientProfile?.role === "employer" && recipientProfile.companyLogo
      ...
      ? `${import.meta.env.VITE_API_BASE_URL}/${recipientProfile.onboarding.profileImage}`
      : "/default-avatar.png";
          ...
          const profileImage =
            isEmployer && companyLogo
              ? companyLogo.startsWith("http")
                ? companyLogo
                : `${import.meta.env.VITE_API_BASE_URL}/${companyLogo}`
              : onboardingProfileImage
              ? `${import.meta.env.VITE_API_BASE_URL}/${onboardingProfileImage}`
              : "/default-avatar.png";
